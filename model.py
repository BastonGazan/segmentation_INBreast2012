...
################# Entrenamiento ####################
    ...
    #Encoding
        for down in self.encoder:
            ...
            x = self.pool(x) #Realiza maxpooling de la imagen para reducir su dimension

        x = self.bottleneck(x)
        skip_connections = skip_connections[::-1] #Invierto la lista para usar del ultimo al primero
